...
VALUES
  ...
  (214, 1,  'The following user did not accept your group invitation'),
  (215, 1,  'The following user has left your group'),
  (216, 1,  'You have left the following group'),
  ...
  (224, 1,  'You have removed a user from your group'),
  (225, 1,  '%d seconds ago'),
  (226, 1,  '%d minutes ago'),
  (227, 1,  '%d hours ago'),
  (228, 1,  '%d days ago'),
  ...
  (212, 2,  'le éloignement'),
  (213, 2,  'erreur de distance'),
  (214, 2,  'L''utilisateur suivant n''a pas accepté votre invitation de groupe'),
  (215, 2,  'L''utilisateur suivant a quitté votre groupe'),
  (216, 2,  'Vous avez quitté le groupe suivant'),
  (217, 2,  'Vous avez une invitation à un utilisateur pour votre groupe'),
  (218, 2,  'Vous avez été offert une invitation à rejoindre un groupe'),
  ...
  (214, 3,  'El siguiente usuario no aceptó su invitación de grupo'),
  (215, 3,  'El siguiente usuario ha salido de tu grupo'),
  (216, 3,  'Has dejado el grupo siguiente'),
  (217, 3,  'Usted ha extendido una invitación a un usuario para su grupo'),
  (218, 3,  'Se le ha ofrecido una invitación para unirse a un grupo'),
  ...
  (212, 5,  'מרחק'),
  (213, 5,  'שגיאת מרחק'),
  (214, 5,  'המשתמש הבא לא קבל את ההזמנה לקבוצה שלך'),
  (215, 5,  'המשתמש הבא הותיר את הקבוצה שלך'),
  (216, 5,  'יש לך עזב את הקבוצה הבאה'),
  (217, 5,  'אתה הרחיבו אתהזמנהלמשתמש עבור הקבוצה שלך'),
  (218, 5,  'כבר הציע לךהזמנה להצטרף לקבוצה'),
