...
VALUES
  ...
  (13,  1,  'Categories'),
  (14,  1,  'Add location'),
  (15,  1,  'Forget it - I don''t need a location'),
  (16,  1,  'The dashboard'),
  (17,  1,  'to'),
  (18,  1,  'Rank average'),
  (19,  1,  'Rank ladder'),
  ...
  (13,  2,  'Catégories'),
  (14,  2,  'Ajouter un emplacement'),
  (15,  2,  'Oublier - je ne ai pas besoin d''un emplacement'),
  ...
  (13,  3,  'Categorías'),
  (14,  3,  'Añadir lugar'),
  (15,  3,  'Olvídalo - No necesito un lugar'),
  ...
  (13,  5,  'קטגוריות'),
  (14,  5,  'הוסף מיקום'),
  (15,  5,  'תשכח מזה - אני לא צריך אתמיקום'),
  (16,  5,  'לוח המחוונים'),
  (17,  5,  'ל'),
  (18,  5,  'ממוצע דירוג'),
  (19,  5,  'סולם דירוג'),
