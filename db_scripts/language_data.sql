...
VALUES
  ...
  (149, 1,  'Help'),
  (150, 1,  'You did not confirm your new password.  Try again.'),
  (151, 1,  'Cancel active favor'),
  ...
  (149, 2,  'Aidez-moi'),
  (150, 2,  'Vous ne l''avez pas confirmer votre nouveau mot de passe . Essaye encore.'),
  (151, 2,  'Annuler faveur actif'),
  (152, 2,  'Adresse 1'),
  (153, 2,  'Adresse 2'),
  (154, 2,  'Ville'),
  (155, 2,  'État'),
  ...
  (149, 3,  'Ayuda'),
  (150, 3,  'Usted no confirme su nueva contraseña. Inténtalo de nuevo.'),
  (151, 3,  'Cancelar favor activa'),
  ...
  (149, 5,  'לעזור'),
  (150, 5,  'אתה לא לאשר את הסיסמה החדשה שלך . נסה שוב.'),
  (151, 5,  'לבטל טובה פעילה'),
  (152, 5,  'כתובת רחוב 1'),
  (153, 5,  'כתובת רחוב 2'),
  (154, 5,  'עיר'),
  (155, 5,  'מדינה'),
