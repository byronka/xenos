...
(178, 2,  'FRENCHAre you asleep? Wake up!  You have'),
(179, 2,  'FRENCHseconds before you are automatically logged out!'),
(180, 2,  'FRENCHhas not yet determined'),
(181, 2,  'FRENCHhave not yet determined'),
(182, 2,  'FRENCHI am not done!'),
(183, 2,  'FRENCHFavor created'),
(184, 2,  'FRENCHYou have created a favor.  Right now, it is in draft mode, unviewable by other users. You may'),
(185, 2,  'FRENCHit now if you wish.  Until you publish, it will remain hidden.  You can also publish this favor from your profile page.'),
(186, 2,  'FRENCHRank user'),
(187, 2,  'FRENCHRank the other user for the following Favor'),
(188, 2,  'FRENCHhappy'),
(189, 2,  'FRENCHunhappy'),
(190, 2,  'FRENCHRanking confirmed'),
(1, 3, 'Buscar'),
(2, 3, 'Solicitud favor '),
(3, 3, 'Salir'),
(4, 3, 'Puntos'),
...
(178, 3,  'SPANISHAre you asleep? Wake up!  You have'),
(179, 3,  'SPANISHseconds before you are automatically logged out!'),
(180, 3,  'SPANISHhas not yet determined'),
(181, 3,  'SPANISHhave not yet determined'),
(182, 3,  'SPANISHI am not done!'),
(183, 3,  'SPANISHFavor created'),
(184, 3,  'SPANISHYou have created a favor.  Right now, it is in draft mode, unviewable by other users. You may'),
(185, 3,  'SPANISHit now if you wish.  Until you publish, it will remain hidden.  You can also publish this favor from your profile page.'),
(186, 3,  'SPANISHRank user'),
(187, 3,  'SPANISHRank the other user for the following Favor'),
(188, 3,  'SPANISHhappy'),
(189, 3,  'SPANISHunhappy'),
(190, 3,  'SPANISHRanking confirmed'),
(1,4,'搜索'),
(2,4,'请求青睐'),
(3,4,'退出'),
(4,4,'分'),
...
(178, 4,  'CHINESEAre you asleep? Wake up!  You have'),
(179, 4,  'CHINESEseconds before you are automatically logged out!'),
(180, 4,  'CHINESEhas not yet determined'),
(181, 4,  'CHINESEhave not yet determined'),
(182, 4,  'CHINESEI am not done!'),
(183, 4,  'CHINESEFavor created'),
(184, 4,  'CHINESEYou have created a favor.  Right now, it is in draft mode, unviewable by other users. You may'),
(185, 4,  'CHINESEit now if you wish.  Until you publish, it will remain hidden.  You can also publish this favor from your profile page.'),
(186, 4,  'CHINESERank user'),
(187, 4,  'CHINESERank the other user for the following Favor'),
(188, 4,  'CHINESEhappy'),
(189, 4,  'CHINESEunhappy'),
(190, 4,  'CHINESERanking confirmed'),
(1, 5, 'חיפוש'),
(2, 5, 'בעד בקשה '),
(3, 5, 'התנתקות'),
(4, 5, 'נקודות'),
...
(178, 5,  'HEBREWAre you asleep? Wake up!  You have'),
(179, 5,  'HEBREWseconds before you are automatically logged out!'),
(180, 5,  'HEBREWhas not yet determined'),
(181, 5,  'HEBREWhave not yet determined'),
(182, 5,  'HEBREWI am not done!'),
(183, 5,  'HEBREWFavor created'),
(184, 5,  'HEBREWYou have created a favor.  Right now, it is in draft mode, unviewable by other users. You may'),
(185, 5,  'HEBREWit now if you wish.  Until you publish, it will remain hidden.  You can also publish this favor from your profile page.'),
(186, 5,  'HEBREWRank user'),
(187, 5,  'HEBREWRank the other user for the following Favor'),
(188, 5,  'HEBREWhappy'),
(189, 5,  'HEBREWunhappy'),
(190, 5,  'HEBREWRanking confirmed');
