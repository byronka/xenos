...
(119, 2,  'FRENCHFavors I have offered to service'),
(120, 2,  'FRENCHOffers to service my favors'),
(121, 2,  'FRENCHIf you would like to offer to service this favor, click the confirm button below.'),
(122, 2,  'FRENCHMy open Favors.'),
(123, 2,  'FRENCHMy Favors being serviced.'),
(124, 2,  'FRENCHMy closed Favors.'),
(125, 2,  'FRENCHMy draft Favors.'),
...
(130, 2,  'FRENCHCancel'),
(131, 2,  'FRENCHYour transaction on favor %d has been canceled by the other party.  Check out your profile page to enter feedback on that transaction.'),
(132, 2,  'FRENCHCongratulations! You have been awarded the right to service Favor %d.  Check your profile for more information.'),
(133, 2,  'FRENCHUnfortunately, you were not accepted to handle Favor %d.'),
(134, 2,  'FRENCHFavor %d, which you were handling, has been completed.'),
(135, 2,  'FRENCHFavor %d, which you were owner of, has been completed.'),
(136, 2,  'FRENCHYou have canceled an active transaction, Favor %d.'),
(137, 2,  'FRENCHChoose'),
(138, 2,  'FRENCHwants to handle'),
(139, 2,  'FRENCHChoose a handler'),
(140, 2,  'FRENCHConfirm that you would like the following user to handle this request.'),
(141, 2,  'FRENCHYou have selected a handler for your Favor!'),
(142, 2,  'FRENCHYou have now selected someone to handle your favor.  That user will be informed, and we will also inform the other users (if any) that they have not been selected.'),
(143, 2,  'FRENCHBabysitting'),
(144, 2,  'FRENCHDog-walking'),
(145, 2,  'FRENCHTaxi'),
(146, 2,  'FRENCHMy system messages'),
(147, 2,  'FRENCHYou have made an offer to handle a Favor'),
(148, 2,  'FRENCHYou have recieved an offer to handle a Favor.'),
(149, 2,  'FRENCHDoes this Favor need a location?'),
(150, 2,  'FRENCHYes'),
(151, 2,  'FRENCHNo'),
(152, 2,  'FRENCHStreet Address 1'),
(153, 2,  'FRENCHStreet Address 2'),
(154, 2,  'FRENCHCity'),
(155, 2,  'FRENCHState'),
(156, 2,  'FRENCHPostal code'),
(157, 2,  'FRENCHCountry'),
(158, 2,  'FRENCHSelect one of your saved locations'),
(159, 2,  'FRENCHOr enter a new address'),
(160, 2,  'FRENCHSave to my favorites'),
(1,   3,  'Búsqueda'),
(2,   3,  'Crear solicitud'),
(3,   3,  'Cerrar sesión'),
(4,   3,  'Puntos'),
...
(119, 3,  'SPANISHFavors I have offered to service'),
(120, 3,  'SPANISHOffers to service my favors'),
(121, 3,  'SPANISHIf you would like to offer to service this favor, click the confirm button below.'),
(122, 3,  'SPANISHMy Favors no one is handling yet.'),
(123, 3,  'SPANISHMy Favors being serviced.'),
(124, 3,  'SPANISHMy closed Favors.'),
(125, 3,  'SPANISHMy draft Favors.'),
...
(130, 3,  'SPANISHCancel'),
(131, 3,  'SPANISHYour transaction on favor %d has been canceled by the other party.  Check out your profile page to enter feedback on that transaction.'),
(132, 3,  'SPANISHCongratulations! You have been awarded the right to service Favor %d.  Check your profile for more information.'),
(133, 3,  'SPANISHUnfortunately, you were not accepted to handle Favor %d.'),
(134, 3,  'SPANISHFavor %d, which you were handling, has been completed.'),
(135, 3,  'SPANISHFavor %d, which you were owner of, has been completed.'),
(136, 3,  'SPANISHYou have canceled an active transaction, Favor %d.'),
(137, 3,  'SPANISHChoose'),
(138, 3,  'SPANISHwants to handle'),
(139, 3,  'SPANISHChoose a handler'),
(140, 3,  'SPANISHConfirm that you would like the following user to handle this request.'),
(141, 3,  'SPANISHYou have selected a handler for your Favor!'),
(142, 3,  'SPANISHYou have now selected someone to handle your favor.  That user will be informed, and we will also inform the other users (if any) that they have not been selected.'),
(143, 3,  'SPANISHBabysitting'),
(144, 3,  'SPANISHDog-walking'),
(145, 3,  'SPANISHTaxi'),
(146, 3,  'SPANISHMy system messages'),
(147, 3,  'SPANISHYou have made an offer to handle a Favor'),
(148, 3,  'SPANISHYou have recieved an offer to handle a Favor.'),
(149, 3,  'SPANISHDoes this Favor need a location?'),
(150, 3,  'SPANISHYes'),
(151, 3,  'SPANISHNo'),
(152, 3,  'SPANISHStreet Address 1'),
(153, 3,  'SPANISHStreet Address 2'),
(154, 3,  'SPANISHCity'),
(155, 3,  'SPANISHState'),
(156, 3,  'SPANISHPostal code'),
(157, 3,  'SPANISHCountry'),
(158, 3,  'SPANISHSelect one of your saved locations'),
(159, 3,  'SPANISHOr enter a new address'),
(160, 3,  'SPANISHSave to my favorites'),
(1,   4,  '搜索'),
(2,   4,  '创建请求'),
(3,   4,  '注销'),
(4,   4,  '点'),
...
(119, 4,  'CHINESEFavors I have offered to service'),
(120, 4,  'CHINESEOffers to service my favors'),
(121, 4,  'CHINESEIf you would like to offer to service this favor, click the confirm button below.'),
(122, 4,  'CHINESEMy Favors no one is handling yet.'),
(123, 4,  'CHINESEMy Favors being serviced.'),
(124, 4,  'CHINESEMy closed Favors.'),
(125, 4,  'CHINESEMy draft Favors.'),
...
(130, 4,  'CHINESECancel'),
(131, 4,  'CHINESEYour transaction on favor %d has been canceled by the other party.  Check out your profile page to enter feedback on that transaction.'),
(132, 4,  'CHINESECongratulations! You have been awarded the right to service Favor %d.  Check your profile for more information.'),
(133, 4,  'CHINESEUnfortunately, you were not accepted to handle Favor %d.'),
(134, 4,  'CHINESEFavor %d, which you were handling, has been completed.'),
(135, 4,  'CHINESEFavor %d, which you were owner of, has been completed.'),
(136, 4,  'CHINESEYou have canceled an active transaction, Favor %d.'),
(137, 4,  'CHINESEChoose'),
(138, 4,  'CHINESEwants to handle'),
(139, 4,  'CHINESEChoose a handler'),
(140, 4,  'CHINESEConfirm that you would like the following user to handle this request.'),
(141, 4,  'CHINESEYou have selected a handler for your Favor!'),
(142, 4,  'CHINESEYou have now selected someone to handle your favor.  That user will be informed, and we will also inform the other users (if any) that they have not been selected.'),
(143, 4,  'CHINESEBabysitting'),
(144, 4,  'CHINESEDog-walking'),
(145, 4,  'CHINESETaxi'),
(146, 4,  'CHINESEMy system messages'),
(147, 4,  'CHINESEYou have made an offer to handle a Favor'),
(148, 4,  'CHINESEYou have recieved an offer to handle a Favor.'),
(149, 4,  'CHINESEDoes this Favor need a location?'),
(150, 4,  'CHINESEYes'),
(151, 4,  'CHINESENo'),
(152, 4,  'CHINESEStreet Address 1'),
(153, 4,  'CHINESEStreet Address 2'),
(154, 4,  'CHINESECity'),
(155, 4,  'CHINESEState'),
(156, 4,  'CHINESEPostal code'),
(157, 4,  'CHINESECountry'),
(158, 4,  'CHINESESelect one of your saved locations'),
(159, 4,  'CHINESEOr enter a new address'),
(160, 4,  'CHINESESave to my favorites'),
(1,   5,  'חיפוש'),
(2,   5,  'צור'),
(3,   5,  'התנתקות'),
(4,   5,  'נקודות'),
...
(119, 5,  'HEBREWFavors I have offered to service'),
(120, 5,  'HEBREWOffers to service my favors'),
(121, 5,  'HEBREWIf you would like to offer to service this favor, click the confirm button below.'),
(122, 5,  'HEBREWMy Favors no one is handling yet.'),
(123, 5,  'HEBREWMy Favors being serviced.'),
(124, 5,  'HEBREWMy closed Favors.'),
...
(130, 5,  'HEBREWCancel'),
(131, 5,  'HEBREWYour transaction on favor %d has been canceled by the other party.  Check out your profile page to enter feedback on that transaction.'),
(132, 5,  'HEBREWCongratulations! You have been awarded the right to service Favor %d.  Check your profile for more information.'),
(133, 5,  'HEBREWUnfortunately, you were not accepted to handle Favor %d.'),
(134, 5,  'HEBREWFavor %d, which you were handling, has been completed.'),
(135, 5,  'HEBREWFavor %d, which you were owner of, has been completed.'),
(136, 5,  'HEBREWYou have canceled an active transaction, Favor %d.'),
(137, 5,  'HEBREWChoose'),
(138, 5,  'HEBREWwants to handle'),
(139, 5,  'HEBREWChoose a handler'),
(140, 5,  'HEBREWConfirm that you would like the following user to handle this request.'),
(141, 5,  'HEBREWYou have selected a handler for your Favor!'),
...
(147, 5,  'HEBREWYou have made an offer to handle a Favor'),
(148, 5,  'HEBREWYou have recieved an offer to handle a Favor.'),
(149, 5,  'HEBREWDoes this Favor need a location?'),
(150, 5,  'HEBREWYes'),
(151, 5,  'HEBREWNo'),
(152, 5,  'HEBREWStreet Address 1'),
(153, 5,  'HEBREWStreet Address 2'),
(154, 5,  'HEBREWCity'),
(155, 5,  'HEBREWState'),
(156, 5,  'HEBREWPostal code'),
(157, 5,  'HEBREWCountry'),
(158, 5,  'HEBREWSelect one of your saved locations'),
(159, 5,  'HEBREWOr enter a new address'),
(160, 5,  'HEBREWSave to my favorites');
