...
(130, 1,  'Cancel'),
(131, 1,  'Your transaction on favor %d has been canceled by the other party.  Check out your profile page to enter feedback on that transaction.'),
(132, 1,  'Congratulations! You have been awarded the right to service Favor %d.  Check your profile for more information.'),
(133, 1,  'Unfortunately, you were not accepted to handle Favor %d.'),
(134, 1,  'Favor %d, which you were handling, has been completed.'),
(135, 1,  'Favor %d, which you were owner of, has been completed.'),
(136, 1,  'You have canceled an active transaction, Favor %d.'),
(137, 1,  'Choose'),
